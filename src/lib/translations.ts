...
export const TRANSLATIONS = {
  ...
  'nav.innovations': { th: 'นวัตกรรม', en: 'Innovations' },
  'nav.about_group': { th: 'เกี่ยวกับเรา', en: 'About' },
  'nav.outputs_group': { th: 'ผลงาน', en: 'Outputs' },

  // === Innovations page ===
  'innov.title': { th: 'นวัตกรรมจากหน่วยวิจัย', en: 'Innovations from CESRU' },
  'innov.subtitle': { th: 'สิทธิบัตร อนุสิทธิบัตร และต้นแบบที่ออกแบบโดยทีม CESRU', en: 'Patents, petty patents, and prototypes designed by the CESRU team' },
  'innov.type.petty_patent': { th: 'อนุสิทธิบัตร', en: 'Petty patent' },
  'innov.type.patent': { th: 'สิทธิบัตร', en: 'Patent' },
  'innov.type.copyright': { th: 'ลิขสิทธิ์', en: 'Copyright' },
  'innov.type.trademark': { th: 'เครื่องหมายการค้า', en: 'Trademark' },
  'innov.type.trade_secret': { th: 'ความลับทางการค้า', en: 'Trade secret' },
  'innov.type.prototype': { th: 'ต้นแบบ', en: 'Prototype' },
  'innov.status.concept': { th: 'แนวคิด', en: 'Concept' },
  'innov.status.filed': { th: 'ยื่นคำขอแล้ว', en: 'Filed' },
  'innov.status.granted': { th: 'ได้รับอนุมัติ', en: 'Granted' },
  'innov.status.expired': { th: 'หมดอายุ', en: 'Expired' },
  'innov.status.abandoned': { th: 'ยกเลิก', en: 'Abandoned' },
  'innov.field.ip_number': { th: 'เลขที่', en: 'IP No.' },
  'innov.field.filed': { th: 'ยื่นคำขอ', en: 'Filed' },
  'innov.field.granted': { th: 'อนุมัติ', en: 'Granted' },
  'innov.field.inventors': { th: 'ผู้ประดิษฐ์', en: 'Inventors' },
  'innov.field.contact': { th: 'ติดต่อขอใช้นวัตกรรม', en: 'Licensing contact' },
  'innov.field.license_fee': { th: 'มูลค่าการให้สิทธิ', en: 'License value' },
  'innov.field.license_type': { th: 'ประเภทสิทธิ', en: 'License type' },
  'innov.field.license_period': { th: 'ระยะเวลาให้สิทธิ', en: 'License period' },
  'innov.field.license_holder': { th: 'ผู้รับสิทธิ', en: 'Licensee' },
  'innov.field.contract_no': { th: 'สัญญาเลขที่', en: 'Contract No.' },
  'innov.field.territory': { th: 'อาณาเขต', en: 'Territory' },
  'innov.field.documents': { th: 'เอกสารแนบ', en: 'Attached documents' },
  'innov.action.view': { th: 'ดูรายละเอียด', en: 'View details' },
  'innov.action.contact': { th: 'ติดต่อ', en: 'Contact' },
  'innov.empty.title': { th: 'ยังไม่มีนวัตกรรมในระบบ', en: 'No innovations yet' },
  'innov.empty.subtitle': { th: 'รอเพิ่มข้อมูลในระบบ Admin', en: 'Innovations will appear here once added' },
